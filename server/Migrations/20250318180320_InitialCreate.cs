    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "john@example.com", "John", "+1234567890" },
                    { 2, "", "jane@example.com", "Jane", "+1234567891" },
                    { 3, "", "mike@example.com", "Mike", "+1234567892" },
                    { 4, "", "sarah@example.com", "Sarah", "+1234567893" }
                });

            migrationBuilder.InsertData(
                table: "Rentals",
                columns: new[] { "Id", "CarId", "CustomerId", "EndDate", "StartDate", "Status", "TotalAmount" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "CarId", "Comment", "CustomerId", "Rating", "ReviewDate" },
                values: new object[,]
                {
                    { 1, 1, "Excellent car, very comfortable!", 1, 5, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, "Good car, but a bit small.", 2, 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 4, "Luxury car, amazing experience!", 3, 5, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 3, "Car was in maintenance, but service was good.", 4, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 250.00m, new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreditCard", 1, "" },
                    { 2, 225.00m, new DateTime(2024, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "PayPal", 2, "" },
                    { 3, 375.00m, new DateTime(2024, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cash", 3, "" },
                    { 4, 320.00m, new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreditCard", 4, "" }
                });
